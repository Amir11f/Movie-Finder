...
export default function PopularMovie() {
  ...
  const popularM = async (pageNumber) => {
    const get = await axios.get(
      `https://api.themoviedb.org/3/discover/movie?api_key=1b6ccfb407b0626e097c87368fba764e&language=en-US&sort_by=popularity.desc&with_genres=${state.state3}&certification=${state.state7}&primary_release_date.gte=${sliderValues[0]}-01-01&primary_release_date.lte=${sliderValues[1]}-${currentMonth}-${currentDay}&certification_country=US&page=${pageNumber}`
    );
    console.log(get);
