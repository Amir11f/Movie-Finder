...
export default function PopularMovie() {
    ...
    const popularM = async (pageNumber)=>{
        const get = await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=(your api key)&language=en-US&with_genres=${state.state3}&certification=${state.state7}&primary_release_date.gte=${sliderValues[0]}-01-01&primary_release_date.lte=${sliderValues[1]}-${currentMonth}-${currentDay}&certification_country=US&page=${pageNumber}`);
