...
export default function NowplayingMovie() {
  ...
  const nowPlayingM = async (pageNumber) => {
    const get = await axios.get(
      `https://api.themoviedb.org/3/movie/now_playing?api_key=1b6ccfb407b0626e097c87368fba764e&language=en-US&page=${pageNumber}&region=US`
    );
      ...
      <div className="position">
        <div className="body">
          <div className="left-side">
            <p className="info">Now playing Movie</p>
