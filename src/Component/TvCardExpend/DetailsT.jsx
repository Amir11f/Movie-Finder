...
function DetailsT() {
  ...
  const movieDitails = async () => {
    const get = await axios.get(
      `https://api.themoviedb.org/3/tv/${tvId}?api_key=1b6ccfb407b0626e097c87368fba764e&language=en-US`
    );
    setGetDTT(get.data);
  ...
  const getCredits = async () => {
    const getapi = await axios.get(
      `https://api.themoviedb.org/3/tv/${getDTT?.id}/credits?api_key=1b6ccfb407b0626e097c87368fba764e&language=en-US`
    );
  ...
  const gerRecommendation = async () => {
    const get = await axios.get(
      `https://api.themoviedb.org/3/tv/${tvId}/recommendations?api_key=1b6ccfb407b0626e097c87368fba764e&language=en-US&page=1`
    );
  ...
  const getSimilarMovie = async () => {
    const get = await axios.get(
      `https://api.themoviedb.org/3/tv/${tvId}/similar?api_key=1b6ccfb407b0626e097c87368fba764e&language=en-US&page=1`
    );
  ...
  const getIMG = async () => {
    const get = await axios.get(
      `https://api.themoviedb.org/3/tv/${tvId}/images?api_key=1b6ccfb407b0626e097c87368fba764e&language=en-US&include_image_language=en`
    );
    setImages(get.data);
    console.log(get.data);
  };
  ...
  const getVideo = async () => {
    const get = await axios.get(
      `https://api.themoviedb.org/3/tv/${tvId}/videos?api_key=1b6ccfb407b0626e097c87368fba764e&language=en-US`
    );
          ...
          <div className="media-section">
            <div className="ulOrg">
              ...
              <ul className="mediaLists">
                ...
                <li
                  className="innerLists"
                  onClick={() => handleListClick("poster")}
                >
                  Posters
                </li>
              </ul>
            ...
            <div className="videoBoxFather">
              {activeList === "video" &&
                trailer.length > 1 &&
                trailer.map((res) => <Videos resV={res} />)}
            </div>
            <div className="backdropsBoxFather">
              {activeList === "backdrop" &&
                images.backdrops?.map((res) => <Backdrops resB={res} />)}
            </div>
            <div className="posterBoxFather">
              {activeList === "poster" &&
                images.posters?.map((res) => <Posters resP={res} />)}
            </div>
          </div>
