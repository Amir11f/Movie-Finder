        ...
        <div className="option1">
          ...
          >
            ...
            <div className={`under1 ${state.ini1 ? "active" : "inactive"}`}>
              ...
              <Link to={"../../pagesM/NowPlayingMovie"} className="under-p">
                Now playing
              </Link>
              <Link to={"../../pagesM/UpComingMovie"} className="under-p">
                Up coming
              </Link>
              <Link
                to={"../../pagesM/TopRatingMovie"}
                className="under-p"
                id="selected2"
              >
                Top rated
          ...
          >
            ...
            <div className={`under2 ${state.ini2 ? "active1" : "inactive1"}`}>
              ...
              <Link to={"../../pagesT/AiringTodayTv"} className="under-p">
                Airing today
              </Link>
              <Link to={"../../pagesT/OnTheAirTv"} className="under-p">
                On TV
              </Link>
              <Link
                to={"../../pagesT/TopRatedTv"}
                className="under-p"
                id="selected2"
              >
                Top rated
          ...
          >
            <div className="menu">
              <p id="menu-p">People</p>
            </div>
            <div className={`under3 ${state.ini3 ? "active2" : "inactive2"}`}>
              <Link to={"/Popular"} className="under-p make" id="selected1">
                Populer people
              </Link>
            </div>
          </div>
            ...
            <div className="navbarOption">
              ...
              >
                ...
                <div className={`under1 ${state.ini1 ? "active" : "inactive"}`}>
                  ...
                  <Link
                    to={"../../pagesM/NowPlayingMovie"}
                    className="under-p1"
                  >
                    Now playing
                  </Link>
                  <Link to={"../../pagesM/UpComingMovie"} className="under-p1">
                    Up coming
                  </Link>
                  <Link
                    to={"../../pagesM/TopRatingMovie"}
              ...
              <div
                className={` ${state.ini2 ? "divid2" : null} `}
                onClick={() => {
                  dispatch({ type: "state2" });
                }}
              >
                ...
                >
                  ...
                  <Link to={"../../pagesT/AiringTodayTv"} className="under-p2">
                    Airing today
                  </Link>
                  <Link to={"../../pagesT/OnTheAirTv"} className="under-p2">
                    On TV
                  </Link>
                  <Link
                    to={"../../pagesT/TopRatedTv"}
              ...
              <div
                className={` ${state.ini3 ? "divid3" : null}`}
                onClick={() => {
                  dispatch({ type: "state3" });
                }}
              >
            ...
            <div className="changeSearch">
              <div id="search">
                <FaSearch
                  id="second-icon"
                  onClick={() => {
                    dispatch({ type: "state6" });
                  }}
                  className={`${state.ini6 ? "hide" : "show"}`}
                />
              </div>
              <div id="search1">
                <RiCloseLine
                  ...
                  className={`${state.ini6 ? "show" : "hide"}`}
                />
              </div>
            </div>
          </div>
